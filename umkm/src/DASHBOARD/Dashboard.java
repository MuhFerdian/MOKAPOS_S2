...
//        this.chart.showPieChart(this.pnlPieChart, ChartManager.LAST_MONTH, "Presentase Penjualan Menu", waktu.getBulan(), waktu.getTahun());
                ...
                .addGroup(pnlSidebarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlSidebarLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlSidebarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lblProfileSidebar, javax.swing.GroupLayout.DEFAULT_SIZE, 242, Short.MAX_VALUE)))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlSidebarLayout.createSequentialGroup()
    ...
    private void btnBahanMouseClicked(java.awt.event.MouseEvent evt) {                                      
        this.setCursor(new Cursor(Cursor.WAIT_CURSOR));
    ...
    private void btnTransaksiMouseClicked(java.awt.event.MouseEvent evt) {                                          
        this.setCursor(new Cursor(Cursor.WAIT_CURSOR));
    ...
    private void btnLaporanMouseClicked(java.awt.event.MouseEvent evt) {                                        
        this.setCursor(new Cursor(Cursor.WAIT_CURSOR));
    ...
    private void btnDashboardMouseClicked(java.awt.event.MouseEvent evt) {                                          
        this.setCursor(new Cursor(Cursor.WAIT_CURSOR));
    ...
    private void btnKaryawanMouseClicked(java.awt.event.MouseEvent evt) {                                         
        this.setCursor(new Cursor(Cursor.WAIT_CURSOR));
    ...
    private void btnPembeliMouseClicked(java.awt.event.MouseEvent evt) {                                        
        this.setCursor(new Cursor(Cursor.WAIT_CURSOR));
    ...
    private void btnSupplierMouseClicked(java.awt.event.MouseEvent evt) {                                         
        this.setCursor(new Cursor(Cursor.WAIT_CURSOR));
    ...
    private void lblTopProfileMouseClicked(java.awt.event.MouseEvent evt) {                                           
        UserProfile dia = new UserProfile(null, true, this);
        dia.setVisible(true);
    }                                          

    private void lblTopProfileMouseEntered(java.awt.event.MouseEvent evt) {                                           
        this.setCursor(new Cursor(Cursor.HAND_CURSOR));
        this.lblTopProfile.setIcon(Gambar.getIcon("ic-window-top-miniuser-entered.png"));
    }                                          

    private void lblTopProfileMouseExited(java.awt.event.MouseEvent evt) {                                          
        this.setCursor(new Cursor(Cursor.DEFAULT_CURSOR));
        this.lblTopProfile.setIcon(Gambar.getIcon("ic-window-top-miniuser.png"));
    }                                         

    private void lblTopSettingMouseClicked(java.awt.event.MouseEvent evt) {                                           
        Pengaturan dia = new Pengaturan(null, true);
        dia.setVisible(true);
    }                                          

    private void lblTopSettingMouseEntered(java.awt.event.MouseEvent evt) {                                           
        this.setCursor(new Cursor(Cursor.HAND_CURSOR));
        this.lblTopSetting.setIcon(Gambar.getIcon("ic-window-top-setting-entered.png"));
    }                                          

    private void lblTopSettingMouseExited(java.awt.event.MouseEvent evt) {                                          
        this.setCursor(new Cursor(Cursor.DEFAULT_CURSOR));
        this.lblTopSetting.setIcon(Gambar.getIcon("ic-window-top-setting.png"));
    }                                         

    private void lblTopInfoMouseClicked(java.awt.event.MouseEvent evt) {                                        
        InfoApp dia = new InfoApp(null, true);
        dia.setVisible(true);
    }                                       

    private void lblTopInfoMouseEntered(java.awt.event.MouseEvent evt) {                                        
        this.setCursor(new Cursor(Cursor.HAND_CURSOR));
        this.lblTopInfo.setIcon(Gambar.getIcon("ic-window-top-info-entered.png"));
    }                                       

    private void lblTopInfoMouseExited(java.awt.event.MouseEvent evt) {                                       
        this.setCursor(new Cursor(Cursor.DEFAULT_CURSOR));
